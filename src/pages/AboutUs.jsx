...
export default function AboutUs() {
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <Helmet>
        <title>
          About | Win Source International - We bring the mountains to your
          doorsteps
        </title>
        <meta
          name="description"
            ...
            <Card className="mb-6">
              ...
              <CardContent>
                <p className="text-lg">
                  ...
                  minerals industry by delivering sustainable solutions for the
                  extraction and supply of high-quality minerals.
                </p>
              </CardContent>
            </Card>
            <Card className="mb-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-lg">
                  ...
                  long-term partnerships through mutual respect, innovation, and
                  a shared commitment to growth in the minerals and mining
                  industry."
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-lg mb-4">
                  Since its establishment in 2008, Win Source International has
                  become a recognized leader in the mining and minerals
                ...
                <ul className="space-y-2 text-lg">
                  ...
                  <li className="flex items-start">
                    <ChevronRight className="mr-2 h-6 w-6 text-primary flex-shrink-0" />
                    <span>
                      Building strategic alliances to secure a steady supply of
